...
namespace RadiantArsenal.Projectiles.Staffs
{
    public class HockeyStickProj : ModProjectile
    {
        ...
        {
            target.immune[projectile.owner] = 14;
        }
        ...
        {
            Player player = Main.player[projectile.owner];
            Projectile.NewProjectile(player.Center, player.DirectionTo(Main.MouseWorld) * 10, mod.ProjectileType("HockeyStickProj3"), projectile.damage, projectile.knockBack, player.whoAmI);
            for (int i = 0; i < 40; i++)
            {
    ...
    public class HockeyStickProj2 : ModProjectile
    {
        public override string Texture => "RadiantArsenal/Projectiles/Staffs/HockeyStickProj";
    ...
    public class HockeyStickProj3 : ModProjectile
    {
        public override string Texture => "RadiantArsenal/Projectiles/Staffs/HockeyStickProj";
