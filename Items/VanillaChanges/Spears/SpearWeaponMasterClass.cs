...
{
    public abstract class SpearWeaponMasterClass : VanillaItemChange
    {
        ...
        public override bool Shoot(Item item, Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                Projectile.NewProjectile(player.Center, speed * 3, mod.ProjectileType(GetType().Name + "Special"), damage * 4, knockBack * 2, player.whoAmI);
