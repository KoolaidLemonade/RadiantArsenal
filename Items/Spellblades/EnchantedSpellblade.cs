...
{
    public class EnchantedSpellblade : RadianceItem
    {
        bool isActive;
        float activeTimer;
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Right click to summon spellblade" + "\nSuccessful strikes will summon enchanted beams to attack enemies" + "\nLasts 8 seconds");
        }
        public override void SafeSetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("EnchantedSpellbladeProj");
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(player.Center, perturbedSpeed * 3, mod.ProjectileType("EnchantedSpellbladeProj"), damage, knockBack, player.whoAmI);
        ...
        {
            if (player.altFunctionUse == 2 && player.itemAnimation > 0 && player.HeldItem.type == mod.ItemType("EnchantedSpellblade"))
            {
                isActive = true;
            }
